...
export const mockMerchItems: MerchItem[] = [
  {
    id: 'm01',
    name: 'Moroii — Logo Tee',
    description: 'Screen-printed logo tee.',
    price: 32,
    currency: 'USD',
    type: 'clothing',
    imageUrl: null,
    variants: [
      { id: 'm01-s', size: 'S', stock: 8 },
      { id: 'm01-m', size: 'M', stock: 10 },
      { id: 'm01-l', size: 'L', stock: 6 },
    ],
  },
  {
    id: 'm02',
    name: 'Nightdrive Hoodie',
    description: 'Heavyweight hoodie with back print.',
    price: 68,
    currency: 'USD',
    type: 'clothing',
    imageUrl: null,
    variants: [
      { id: 'm02-m', size: 'M', stock: 5 },
      { id: 'm02-l', size: 'L', stock: 5 },
      { id: 'm02-xl', size: 'XL', stock: 0 },
    ],
  },
  {
    id: 'm03',
    name: 'VHS Tape — Live in Berlin',
    description: 'Limited-run VHS of the Berlin show.',
    price: 24,
    currency: 'USD',
    type: 'misc',
    imageUrl: null,
    variants: [{ id: 'm03-default', size: null, stock: 15 }],
  },
  {
    id: 'm04',
    name: 'Analog Grain Cap',
    description: 'Embroidered cap.',
    price: 28,
    currency: 'USD',
    type: 'clothing',
    imageUrl: null,
    variants: [{ id: 'm04-default', size: null, stock: 12 }],
  },
  {
    id: 'm05',
    name: 'Vinyl — Bloodmoon EP',
    description: 'Bloodmoon EP on vinyl.',
    price: 36,
    currency: 'USD',
    type: 'misc',
    imageUrl: null,
    variants: [{ id: 'm05-default', size: null, stock: 0 }],
  },
  {
    id: 'm06',
    name: 'Enamel Pin Set',
    description: 'Set of three enamel pins.',
    price: 16,
    currency: 'USD',
    type: 'misc',
    imageUrl: null,
    variants: [{ id: 'm06-default', size: null, stock: 20 }],
  },
]
